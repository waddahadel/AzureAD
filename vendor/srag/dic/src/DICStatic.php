...
namespace srag\DIC\AzureAD;

use ilLogLevel;
use ilPlugin;
use srag\DIC\AzureAD\DIC\DICInterface;
use srag\DIC\AzureAD\DIC\Implementation\ILIAS54DIC;
use srag\DIC\AzureAD\DIC\Implementation\ILIAS60DIC;
use srag\DIC\AzureAD\Exception\DICException;
use srag\DIC\AzureAD\Output\Output;
use srag\DIC\AzureAD\Output\OutputInterface;
use srag\DIC\AzureAD\Plugin\Plugin;
use srag\DIC\AzureAD\Plugin\PluginInterface;
use srag\DIC\AzureAD\Version\Version;
use srag\DIC\AzureAD\Version\VersionInterface;

/**
 * Class DICStatic
 *
 * @package srag\DIC\AzureAD
 *
