...
namespace srag\RemovePluginDataConfirm\AzureAD;
...
use ilSession;
use ilUtil;
use srag\DIC\AzureAD\DICStatic;
use srag\DIC\AzureAD\DICTrait;

/**
 * Class RemovePluginDataConfirmCtrl
 *
 * @package           srag\RemovePluginDataConfirm\AzureAD
 *
 * @author            studer + raimann ag - Team Custom 1 <support-custom1@studer-raimann.ch>
 *
 * @ilCtrl_isCalledBy srag\RemovePluginDataConfirm\AzureAD\RemovePluginDataConfirmCtrl: ilUIPluginRouterGUI
 */
class RemovePluginDataConfirmCtrl
{
