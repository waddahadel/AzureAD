...
namespace srag\ActiveRecordConfig\AzureAD;

use arConnector;
use srag\ActiveRecordConfig\AzureAD\Config\AbstractFactory;
use srag\ActiveRecordConfig\AzureAD\Config\AbstractRepository;
use srag\ActiveRecordConfig\AzureAD\Config\Config;
use srag\ActiveRecordConfig\AzureAD\Exception\ActiveRecordConfigException;

/**
 * Class ActiveRecordConfig
 *
 * @package    srag\ActiveRecordConfig\AzureAD
 *
